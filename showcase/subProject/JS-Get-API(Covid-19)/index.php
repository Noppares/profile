            ...
            <div class="row">
                <div class="col-6 mx-auto">
                    ...
                    <div class="card text-center text-white bg-danger mb-3">
                        ...
                        <div class="card-body">
                          <h5 class="card-title"><?php echo number_format($data["cases"]);?></h5>
                          <p class="card-text text-white">(เพิ่มขึ้น <?php echo number_format($data["todayCases"]);?>)</p>
                        </div>
                      </div>
                </div>
            </div>
                ...
                <div class="col-4">
                    <div class="card text-center text-white bg-success mb-3" >
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text text-white">(เพิ่มขึ้น <?php echo number_format($data["todayRecovered"]);?>)</p>
                        </div>
                      </div>
                </div>
                <div class="col-4">
