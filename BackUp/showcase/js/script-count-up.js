!(function (t, i) {
  ...
  var s = function () {
    ...
    i =
      ...
      (a.prototype.printValue = function (t) {
      ...
      (a.prototype.ensureNumber = function (t) {
        return "number" == typeof t && !isNaN(t);
      }),
      (a.prototype.validateValue = function (t) {
        var i = Number(t);
    ...
    (this.target = t),
        ...
        (r.remaining = r.duration - t),
          r.useEasing
            ? r.countDown
              ? (r.frameVal =
                  r.startVal -
                  r.easingFn(t, 0, r.startVal - r.endVal, r.duration))
            ...
            : r.countDown
            ? (r.frameVal =
                r.startVal - (r.startVal - r.endVal) * (t / r.duration))
            : (r.frameVal =
                r.startVal + (r.endVal - r.startVal) * (t / r.duration)),
          r.countDown
            ? (r.frameVal = r.frameVal < r.endVal ? r.endVal : r.frameVal)
            : (r.frameVal = r.frameVal > r.endVal ? r.endVal : r.frameVal),
      ...
      (this.formatNumber = function (t) {
        ...
        if (r.options.useGrouping) {
          for (var s = "", n = 0, e = a.length; n < e; ++n)
            0 !== n && n % 3 == 0 && (s = r.options.separator + s),
              (s = a[e - n - 1] + s);
          a = s;
        }
        return (
          ...
          i + r.options.prefix + a + t + r.options.suffix
        );
      }),
  ...
  (t.CountUp = i), Object.defineProperty(t, "__esModule", { value: !0 });
});
...
window.addEventListener("scroll", s_counters, { passive: false });
